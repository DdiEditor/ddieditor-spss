...
public class ProblemView extends MarkerSupportView {
	static final String contentGeneratorId = "dk.dda.ddieditor.spss.view.problemMarkerContentGenerator";
	public static final String ID = "dk.dda.ddieditor.spss.view.ProblemView";	
	public static final String MARKER_ID="dk.dda.ddieditor.spss.view.marker";
